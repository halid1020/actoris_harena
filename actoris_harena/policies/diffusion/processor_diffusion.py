...
make_harena_diffusion_pre_post_processors = make_diffusion_pre_post_processors
# And under the former name, for a config decoded from an older checkpoint that
# somehow reports the legacy type.
make_so101_diffusion_pre_post_processors = make_diffusion_pre_post_processors
