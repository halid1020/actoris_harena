...
@PreTrainedConfig.register_subclass("harena_diffusion")
@dataclass
class HarenaDiffusionConfig(PreTrainedConfig):
...
DiffusionConfig = HarenaDiffusionConfig
...
PreTrainedConfig.register_subclass("so101_diffusion", HarenaDiffusionConfig)
