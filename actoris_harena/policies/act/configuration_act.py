...
@PreTrainedConfig.register_subclass("harena_act")
@dataclass
class HarenaActConfig(PreTrainedConfig):
...
PreTrainedConfig.register_subclass("so101_act", HarenaActConfig)
