...
@PreTrainedConfig.register_subclass("harena_fastwam")
@dataclass
class HarenaFastwamConfig(PreTrainedConfig):
...
FastWAMConfig = HarenaFastwamConfig
...
PreTrainedConfig.register_subclass("so101_fastwam", HarenaFastwamConfig)
