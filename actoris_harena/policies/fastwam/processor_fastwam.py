...
from ..common.processor_compat import (
...
make_harena_fastwam_pre_post_processors = make_fastwam_pre_post_processors
# And under the former name, for a config decoded from an older checkpoint that
# somehow reports the legacy type.
make_so101_fastwam_pre_post_processors = make_fastwam_pre_post_processors
