...
Everything about the model is its twin's: this subclasses `HarenaActConfig` and
...
from ..act.configuration_act import HarenaActConfig
from ..common.tactile import DEFAULT_CROP, TACTILE_CAMERAS


@PreTrainedConfig.register_subclass("harena_act_crop")
@dataclass
class HarenaActCropConfig(HarenaActConfig):
    """HarenaActConfig plus a centred crop on the fingertip cameras."""
...
PreTrainedConfig.register_subclass("so101_act_crop", HarenaActCropConfig)
