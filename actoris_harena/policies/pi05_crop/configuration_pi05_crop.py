...
Everything about the model is its twin's: this subclasses `HarenaPi05Config` and
...
@PreTrainedConfig.register_subclass("harena_pi05_crop")
@dataclass
class HarenaPi05CropConfig(HarenaPi05Config):
    """HarenaPi05Config plus a centred crop on the fingertip cameras."""
...
PreTrainedConfig.register_subclass("so101_pi05_crop", HarenaPi05CropConfig)
