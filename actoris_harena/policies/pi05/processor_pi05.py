...
@ProcessorStepRegistry.register(name="harena_pi05_prepare_state_tokenizer_processor_step")
@dataclass
...
make_harena_pi05_pre_post_processors = make_pi05_pre_post_processors
# And under the former name, for a config decoded from an older checkpoint that
# somehow reports the legacy type.
make_so101_pi05_pre_post_processors = make_pi05_pre_post_processors
