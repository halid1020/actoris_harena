...
@PreTrainedConfig.register_subclass("harena_pi05")
@dataclass
class HarenaPi05Config(PreTrainedConfig):
...
PreTrainedConfig.register_subclass("so101_pi05", HarenaPi05Config)
